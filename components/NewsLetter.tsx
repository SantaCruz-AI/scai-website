...
const NewsLetter = () => {
    ...
    return (
        <div className="">
            <form className=" col-span-2 sm:col-span-1 mx rounded-md border-r-2 border-b-2  p-2 ">
                    <label className="pb-4 ">
                        ...
                        <input className=" m-4 p-2 rounded-lg border-r-2 border-l-2 border-b-2 " type="text" name="name" placeholder="email$%#"/>
                    </label>
