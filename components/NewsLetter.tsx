...
const NewsLetter = () => {
    ...
    const handleSubmit = async (event :any) => {
        ...
        await newsLetterSignUp(event.target[0].value);
    };
        ...
        <div className="">
            <form onSubmit={handleSubmit} className=" col-span-2 sm:col-span-1 mx rounded-md border-r-2 border-b-2  p-2 ">
                    <label className="pb-4 ">
                        ...
                        <input id="email" className=" m-4 p-2 rounded-lg border-r-2 border-l-2 border-b-2 " type="email" name="email" placeholder="email$%#"/>
                    </label>
