...
import { useGLTF, Stats, OrbitControls, useCubeTexture } from '@react-three/drei'
...
const Bulb =  (props:any) => {
    ...
    const texture = useCubeTexture(["px.png","nx.png","py.png","ny.png","nz.png","pz.png"],{ path: "envMap/"});
    ...
    return (
        <>
         <primitive ref={ref} position={[0,-2,0]} scale={2} object={bulb.scene} />
        </>
